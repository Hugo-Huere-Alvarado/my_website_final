...
review score above 95/100 will cost, on average, 2,063 MXN $ with a 95% confidence interval ranging from 2,035 to 2,090.
...
```{r, fig.width=27, fig.height=27, out.width="100%"}
...
model2
```
For each increase in review_scores_rating, the price of two people for 4 nights will increase by 10.24. If the property type is condominium, the price of 2 people for 4 nights will increase by 229.18; if the property type is house, the price of 2 people for 4 nights will decrease by 1322.8;If the property type is loft, the price of 2 people for 4 nights will increase by 180.51; If the property type is other, the price of 2 people for 4 nights will decrease by 425.48.
