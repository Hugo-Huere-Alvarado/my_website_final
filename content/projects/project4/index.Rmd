...
The aim od this project is to identify the top ten cities by highest amounts raised in political contributions in California during the 2016 US Presidential election.
...
```{r, warning=FALSE, message=FALSE, echo=FALSE, fig.width = 30, fig.height=16}
