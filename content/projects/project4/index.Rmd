...
Firstly, we load all the contributions. I am showing you the first twenty but there are actually almost 1.3m observations in total.
...
```{r, warning=FALSE, message=FALSE, echo=FALSE, fig.width = 30, fig.height=14}
